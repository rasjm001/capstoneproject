...
#test adversarial samples against A K' models.
...
# Define classifiers with initial settings from Code 1
...
# Hyperparameter grids from Code 1
param_grids = {
    'RandomForest': {
        'n_estimators': [50, 75],
        'max_depth': [3, 5, 7],
...
indices_not_to_perturb = [i for i in range(X_test.shape[1]) if i not in indices_to_perturb]
